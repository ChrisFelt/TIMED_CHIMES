...
class Ui_SettingsWidget(object):
    ...
    def retranslateUi(self, SettingsWidget):
        ...
        self.label_2.setText(QCoreApplication.translate("SettingsWidget", u"Current Sound:", None))
        self.sound_title_label.setText(QCoreApplication.translate("SettingsWidget", u"Sound Title Place Holder", None))
    # retranslateUi
